  ...
  <div ref="outer" class="rz-breakout">
    <div ref="box" data-testid="rz-box" class="relative mx-auto" :style="boxStyle">
      ...
      <div
        ...
        class="absolute top-0 -right-5 hidden h-full w-5 cursor-ew-resize items-center justify-center opacity-70 transition-opacity hover:opacity-100 lg:flex"
        @mousedown="onDown"
      >
        <span
          class="flex h-20 flex-col items-center justify-center gap-1 rounded-full border border-white bg-zinc-800/80 px-1.5 py-2"
        >
